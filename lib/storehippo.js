...
function StorehippoSDK(config) {
    ...
    self.addRecord = function (entity, data) {
        return new Promise((resolve, reject) => {
            var request = {
                entity: entity,
                command: 'add',
            ...
            self.call(request, function (err, response) {
                if (err) return reject(err);
                resolve(response.data && response.data._id);
            });
        });
    }

    self.listRecords = function (entity, query) {
        return new Promise((resolve, reject) => {
            var request = {
                entity: entity,
                command: 'list',
    ...
    self.updateRecord = async function (entity, record_id, data) {
        return new Promise((resolve, reject) => {
            var request = {
                entity: entity,
                recordId: record_id,
    ...
    self.deleteRecord = async function (entity, record_id) {
        return new Promise((resolve, reject) => {
            var request = {
                entity: entity,
                recordId: record_id,
    ...
    self.getRecord = async function (entity, record_id) {
        return new Promise((resolve, reject) => {
            var request = {
                entity: entity,
                command: 'get',
